...
const listTest = [
  {
    textUser: "Who are you?",
    textGPT:
      "I am ChatGPT, a large language model developed by OpenAI based on the GPT (Generative Pre-trained Transformer) architecture. I am designed to respond to a wide range of prompts and questions with human-like language. My goal is to assist and provide information to those who interact with me.",
  },
];
$(document).ready(function () {
  // test_item-active
  const htmls = listTest.map((ques, index) => {
    return `
          <div class="test_item">
            <div class="test_item-body">
              ...
              <div class="test_item-text">Who are you?</div>
            </div>
          </div>
          ...
          <div class="test_item test_item-active">
              <div class="test_item-body">
                ...
                <div class="test_item-text">I am ChatGPT, a large language model developed by OpenAI based on the GPT (Generative Pre-trained Transformer) architecture. I am designed to respond to a wide range of prompts and questions with human-like language. My goal is to assist and provide information to those who interact with me.</div>
              </div>
          </div> 
