...
const listTest = [
  ...
  {
    isUser: false,
    text: "I am ChatGPT, a large language model developed by OpenAI based on the GPT (Generative Pre-trained Transformer) architecture. I am designed to respond to a wide range of prompts and questions with human-like language. My goal is to assist and provide information to those who interact with me.",
  },
];
$(document).ready(function () {
  // test_item-active
