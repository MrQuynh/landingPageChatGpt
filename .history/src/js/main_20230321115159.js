...
scrollbar.addEventListener("scroll", scrolled);
// model buy
const modelBuy = () => {};
...
$(document).ready(function () {
  $(".question_item").on("click", function (e) {
    ...
    // console.log("hello", e.target.closest(".question_item-answer"));
  });
});
// /////question
...
listQuestions.onClick = function (e) {
  // const item = e.target.closest(".question_item");
  console.log("hello");
};
questionRender();
// const handleEvent = () => {
//   listQuestions.onClick = (e) => {
//     const item = e.target.closest(".question_item");
//     console.log("hello");
//   };
// };
